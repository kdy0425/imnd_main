...
var SimpleBar = (function () {
    ...
    function S(t, e, i) {
        ...
        return (
            (e = y(e) || 0),
            f(i) && ((h = !!i.leading), (l = (u = "maxWait" in i) ? O(y(i.maxWait) || 0, e) : l), (d = "trailing" in i ? !!i.trailing : d)),
            (x.cancel = function () {
    ...
    var C = !("undefined" == typeof window || !window.document || !window.document.createElement),
        T = Object.freeze({ __proto__: null, addClasses: N, canUseDOM: C, classNamesToQuery: z, getElementDocument: W, getElementWindow: k, getOptions: M, removeClasses: L }),
        D = null,
        R = null;
    function V() {
        if (null === D) {
        ...
        X = (function () {
            function t(e, i) {
                    ...
                    (this.onPointerEvent = function (t) {
                        ...
                        s.axis.x.track.el &&
                            ...
                            (e || i) &&
                                ...
                                "pointerdown" === t.type &&
                                    "touch" !== t.pointerType &&
                                    (e && ((s.axis.x.scrollbar.rect = s.axis.x.scrollbar.el.getBoundingClientRect()), s.isWithinBounds(s.axis.x.scrollbar.rect) ? s.onDragStart(t, "x") : s.onTrackClick(t, "x")),
                                    i && ((s.axis.y.scrollbar.rect = s.axis.y.scrollbar.el.getBoundingClientRect()), s.isWithinBounds(s.axis.y.scrollbar.rect) ? s.onDragStart(t, "y") : s.onTrackClick(t, "y")))));
                    }),
                ...
                (this.onMouseMove = (function (t, e, i) {
                    var s = !0,
                        r = !0;
                    if ("function" != typeof t) throw new TypeError("Expected a function");
                    return f(i) && ((s = "leading" in i ? !!i.leading : s), (r = "trailing" in i ? !!i.trailing : r)), S(t, e, { leading: s, maxWait: e, trailing: r });
            ...
            return (
                (t.getRtlHelpers = function () {
                    ...
                    i.scrollLeft = -999;
                    var o = t.getOffset(s);
                    return document.body.removeChild(i), (t.rtlHelpers = { isScrollOriginAtZero: r.left !== l.left, isScrollingToNegative: l.left !== o.left }), t.rtlHelpers;
                }),
                ...
                (t.prototype.onMouseMoveForAxis = function (t) {
                    ...
                    e.track.el &&
                        ...
                        this.isWithinBounds(e.track.rect)
                            ? (this.showScrollbar(t), _(e.track.el, this.classNames.hover), this.isWithinBounds(e.scrollbar.rect) ? _(e.scrollbar.el, this.classNames.hover) : q(e.scrollbar.el, this.classNames.hover))
                    ...
                    if (this.options.clickOnTrack && n.scrollbar.el && this.contentWrapperEl) {
                        ...
                        var c = null !== (s = null === (i = this.axis[e].scrollbar.rect) || void 0 === i ? void 0 : i[this.axis[e].offsetAttr]) && void 0 !== s ? s : 0,
                            ...
                            v = function () {
                                o.contentWrapperEl &&
                                    (-1 === d
                                        ? u > p && ((u -= 40), (o.contentWrapperEl[o.axis[e].scrollOffsetAttr] = u), a.requestAnimationFrame(v))
                                        : u < p && ((u += 40), (o.contentWrapperEl[o.axis[e].scrollOffsetAttr] = u), a.requestAnimationFrame(v)));
                            };
                        v();
                    }
